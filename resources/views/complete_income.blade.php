            ...
            <div class="ibox-content">
                <div class="row">
                    ...
                    <div class="col-sm-3" style="margin-top:25px;">
                        <a href="income" type="button" class="btn btn-sm btn-primary">{{trans('file.show_loan_patient')}}</a>
                    </div>
                    <table class="table table-striped table-bordered table-hover" id="editable"
                        ...
                        @foreach($income as $incom)
                            <tr class="gradeX">
                                ...
                                <td>
                                    <a href="/patient_report/{{$incom->id}}" class="btn btn-xs btn btn-primary"><i class="fa fa-print"></i>&nbsp;&nbsp;{{trans('file.print_bill')}}</a>
                                </td>
