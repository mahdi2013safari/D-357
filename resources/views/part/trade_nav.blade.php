...
<div class="row" style="margin-left:2px;margin-right: 20px;">
    ...
    <div class="col-sm-2">
        <h1><a class="btn btn-primary hvr-grow-shadow" style="font-size: 13px;  margin-left: 20px;"
               href="/common">&nbsp;&nbsp;<strong>Buying and Paying</strong> &nbsp;<img src="{{ asset('img/buyingitem.png') }}" width="20px"/></a></h1>
    </div>
    <div class="col-sm-1">
        <h1><a class="btn btn-primary hvr-grow-shadow" style="font-size: 13px; width: 130px; "
