                        ...
                        <form method="post" class="form-horizontal" action="/doctors">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3"><div class="i-checks"><label><input type="radio" value="Male" name="gender"  required><i></i> Male </label></div></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3"><label><input type="radio" name="salary_type" value="percentage" id="per" onclick="perSal()" style="height: 25px;width:25px;" required><i></i>Per%</label></div>
                                    <div class="col-sm-3"><label><input type="radio" name="salary_type" onclick="fixSal()" id="fix" value="fix" style="height: 25px;width:25px;"> <i></i> Fix </label></div>
                                </div>

                                <div class="form-group">
                                  <label class=" control-label" id="label">Salaryamount</label>
                                  <input type="number" class="form-control" name="salary_amount" id="sal" required>
                                </div>

                                <div class="form-group"><label class=" control-label" id="label">Email</label>
                                    <input type="email" class="form-control" name="email"  required>
                                </div>

                                <div class="form-group"><label class=" control-label" id="label">password</label>
