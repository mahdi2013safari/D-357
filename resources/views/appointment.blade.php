                                    ...
                                    <div id="home" class="tab-pane active">
                                        <div class="panel-body">
                                            <div class="row" style="margin-top:80px;">
                                                <div class="col-10">
                                                    <strong class="text-success" style="font-size: 20px;">ALL PATIENTS
                                                        RELATED TO A SPECIFIC DOCTOR WILL BE DISPLAYED HERE!</strong>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row" style="margin-top:-120px;">
                                                <div class="col-sm-5">
                                                    <div class="input-group">
                                                        ...
                                                        <button type="button"
                                                                class="btn btn-sm btn-success"> Go!</button> </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-11">
                                                    <table class="table table-hover no-margins">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td></i>Dr.Samim</td>
                                                            <td>First Time</td>
                                                            <td><i class="fa fa-calendar"></i>&nbsp;2018/8/1 - 8:00 AM
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td></i>Dr.Samim</td>
                                                            <td>Second Time</td>
                                                            <td><i class="fa fa-calendar"></i>&nbsp;2018/8/1 - 8:20 AM
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td></i>Dr.Samim</td>
                                                            <td>First Time</td>
                                                            <td><i class="fa fa-calendar"></i>&nbsp;2018/8/2 - 9:00 AM
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td></i>Dr.Samim</td>
                                                            <td>Second Time</td>
                                                            <td><i class="fa fa-calendar"></i>&nbsp;2018/8/3 - 10:00 AM
                                                            </td>
                                                            <td class="">Diabetics</td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td></i>Dr.Samim</td>
                                                            <td>First Time</td>
                                                            <td><i class="fa fa-calendar"></i>&nbsp;2018/8/3 - 11:00 AM
                                                            </td>
                                                            <td class="">Blood pressure</td>
                                                        </tr>
                                                        </tbody>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content animated fadeIn">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-success">More History &nbsp;<i
