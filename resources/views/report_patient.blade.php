...
@section('content')
    ...
    <!-- daily -->
    <div class="row page-wrapper border-bottom white-bg collapse " id="day" style="margin-top:-20px;margin-left: 1px; margin-bottom: 20px; padding-bottom: 15px;">
            <div class="col-md-2">
                <h2><a class="btn btn-primary" data-toggle="collapse" style="height:70px; width:155px; background: #f56138;" href="#"><i class="fa fa-calendar-o" style="font-size: 30px; color:#ff9f00 ;"></i> <br/>Patient</a></h2>
            </div>
            <div class="col-md-2">
                <h2><a class="btn btn-primary" data-toggle="collapse" style="height:70px; width:155px; background: #f56138;" href="#"><i class="fa fa-calendar" style="font-size: 30px; color:#ff9f00 ;"></i> <br/>Doctors</a></h2>
            </div>
    </div>
    <!-- End of Daily-->

    <!-- Weekly -->
    <div class="row page-wrapper border-bottom white-bg collapse " id="week" style="margin-top:-20px;margin-left: 1px; margin-bottom: 20px; padding-bottom: 15px;">
            <div class="col-md-2">
                <h2><a class="btn btn-primary" data-toggle="collapse" style="height:70px; width:155px; background: #2f284f;" href="#"><i class="fa fa-calendar-o" style="font-size: 30px; color:#ff9f00 ;"></i> <br/>Patient</a></h2>
            </div>
            <div class="col-md-2">
                <h2><a class="btn btn-primary" data-toggle="collapse" style="height:70px; width:155px; background: #2f284f;" href="#"><i class="fa fa-calendar" style="font-size: 30px; color:#ff9f00 ;"></i> <br/>Doctors</a></h2>
            </div>
    </div>
    <!--End of  Weekly -->

    <!-- Monthly -->
    <div class="row page-wrapper border-bottom white-bg collapse " id="month" style="margin-top:-20px;margin-left: 1px; margin-bottom: 20px; padding-bottom: 15px;">
            <div class="col-md-2">
                <h2><a class="btn btn-primary" data-toggle="collapse" style="height:70px; width:155px; background: #199b8a;" href="#"><i class="fa fa-calendar-o" style="font-size: 30px; color:#ff9f00 ;"></i> <br/>Patient</a></h2>
            </div>
            <div class="col-md-2">
                <h2><a class="btn btn-primary" data-toggle="collapse" style="height:70px; width:155px; background: #199b8a;" href="#"><i class="fa fa-calendar" style="font-size: 30px; color:#ff9f00 ;"></i> <br/>Doctors</a></h2>
            </div>
    </div>
    <!-- End of Monthly -->
