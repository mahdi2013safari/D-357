    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                ...
                <h5>X-ray Income Statement <i class="fa fa-info"></i></h5>

                <div class="ibox-tools">
                    <a href="/other-income" class="btn btn-primary btn-lg">Back &nbsp;<span
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row shadow p-3 mb-5 bg-white rounded"
                            ...
                            <h3 style="font-weight: bold">X-ray Fee Bill</h3>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $xry->patient_id}}</td>
                                        <td><strong>Payer</strong> </td>
                                        <td>{{ $xry->patient_name}}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Amount</strong></td>
                                        <td>{{$xry->paid_amount}}</td>
                                        <td><strong>X-ray Status</strong> </td>
                                        <td>{{$xry->xray_status}}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Date</strong></td>
                                        <td>{{$xry->created_at}}</td>
                                    </tr>
