        ...
        <div class="col-md-2">
            <h2><div class="dropdown hvr-float-shadow" style="width: 100%;">
                    ...
                    <ul class="dropdown-menu" style="margin-left:10px; font-size: 17px;">
                        ...
                        <li><a href="#">Expenditure &nbsp;<i class="fa fa-exchange"></i></a></li>
                    </ul>
                </div></h2>
        </div>
    ...
    <div class="col-lg-12 collapse" id="income" >
        ...
        <div class="tabs-container">
            <ul class="nav nav-tabs">
                <li class="active hvr-glow"><a data-toggle="tab" href="#tab-1" >Patient &nbsp; <i class="fa fa-medkit"></i></a></li>
                <li class=" hvr-glow" style="margin-left:7px;"><a data-toggle="tab" href="#tab-2" style="background: #d4ee3d">Others &nbsp;<i class="fa fa-user"></i></a></li>
            </ul>
