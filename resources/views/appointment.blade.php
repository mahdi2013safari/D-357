    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <a href="/patient"><button class="btn btn-success"><li class="fa fa-plus"></li>&nbsp;  Add new Patient</button></a>
                    </div>
                </div>
                <br/>
                <div class="row">
                    <div class="col-md-4">
                        <div class="btn-group">
                            <button class="btn btn-white" type="button"><i class="fa fa-arrow-left"></i>&nbsp; Pre day</button>
                            <button class="btn btn-primary" type="button">Today</button>
                            <button class="btn btn-white" type="button">Next day &nbsp;<i class="fa fa-arrow-right"></i></button>
                        </div>
                    </div>
                    <div class="col-sm-3">
